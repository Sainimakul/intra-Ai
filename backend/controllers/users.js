...
const updateProfile = async (req, res) => {
  ...
  const result = await pool.query(
    `UPDATE users SET ${updates.join(', ')} WHERE id = $${idx} RETURNING id, name, email, avatar_url`,
    values
  );
...
const contactUs = async (req, res) => {
  ...
  try {
    await sendEmail({
      to: 'support@update.makulsaini.online',
...
module.exports = { updateProfile, changePassword, deleteAccount, contactUs };